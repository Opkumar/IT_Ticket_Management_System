...
// import TicketAdmin from "@/components/ticket-admin-component"
// import ItTable from "@/components/it-table-component"
import TicketAdmin from "@/components/TicketAdminComponent";
import ItTable from "@/components/ItTableComponent";
import useTicketStore from "@/store/useTicketStore"
import useAuthStore from "@/store/useAuthStore"
            ...
            <nav className="grid gap-1 px-2">
              {navItems.map((item) => (
                <Button
                  ...
                  className={`flex justify-start gap-3 ${activeView === item.id ? "bg-gray-800 text-white" : ""}`}
                  onClick={() => {
