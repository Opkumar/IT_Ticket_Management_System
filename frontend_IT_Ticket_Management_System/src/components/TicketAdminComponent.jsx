...
export default function TicketAdmin({ allUsers, allTickets: data }) {
  ...
  const downloadExcel = () => {
    ...
    const tableData = table.getRowModel().rows.map((row) => {
      return {
        "Full Name": `${row.original.fullname?.firstname || ""} ${row.original.fullname?.lastname || ""}`,
        Email: row.original.email || "N/A",
        "Assigned Time": row.original.assignedAt ? getFormattedDateAndTime(row.original.assignedAt) : "N/A",
        "Start Working": row.original.startToTicket
          ? getFormattedDateAndTime(row.original.startWorkingOnTicketIssueTime)
          : "N/A",
        "Reached Address": row.original.reachIssueAddress
          ? getFormattedDateAndTime(row.original.reachAddressIssueTime)
          : "N/A",
        "Started Solving": row.original.solvingIssue ? getFormattedDateAndTime(row.original.solvingIssueTime) : "N/A",
        "Completed Issue": row.original.completedIssue ? getFormattedDateAndTime(row.original.completedTime) : "N/A",
        "User Issue Reason": row.original.userIssueReasonDetail || "N/A",
      }
    })
  ...
  const table = useReactTable({
    ...
    getFilteredRowModel: getFilteredRowModel(),
    globalFilterFn: (row, _columnIds, filterValue) => {
      const columnsToFilter = ["issueDetail", "urgent", "typeIssue", "date", "time", "assigned", "status"]
                            ...
                            <TableCell colSpan={columns.length}>
                              <Card>
                                <CardContent className="p-4">
                                  <h4 className="font-semibold text-xl mb-4">Ticket Detail</h4>
                                  <div className="space-y-4">
                                    <div className="border rounded-md p-3 bg-white">
                                      <h2 className="text-lg font-medium">Ticket Raised By:</h2>
                                      <p>
                                    ...
                                    {ticketDetails ? (
                                      <div className="border rounded-md p-3 bg-white">
                                        <h2 className="text-lg font-medium mb-2">Ticket History</h2>
                                        <ScrollArea className="h-[300px] md:h-auto md:max-h-[400px]">
                                          <div className="space-y-2">
                                            ...
                                            <div className="flex items-center gap-2">
                                              ...
                                              <div>
                                                <p className="font-medium">Reached Issue Address:</p>
                                                {ticketDetails.reachIssueAddress ? (
                                                  <p className="text-sm text-gray-600">
                                                    {new Date(ticketDetails.reachAddressIssueTime).toLocaleString(
                                                      "en-US",
                                                      {
                                                        year: "numeric",
                                                        month: "long",
                                                  ...
                                                  <p className="text-sm text-gray-500">Not reached</p>
                                                )}
                                              </div>
                                            </div>
                                            ...
                                            <div className="flex items-center gap-2">
                                              ...
                                              <div>
                                                <p className="font-medium">Started Solving Issue:</p>
                                                {ticketDetails.solvingIssue ? (
                                                  <p className="text-sm text-gray-600">
                                                    {new Date(ticketDetails.solvingIssueTime).toLocaleString("en-US", {
                                                      year: "numeric",
                                                      month: "long",
                                                      day: "numeric",
                                                      hour: "numeric",
                                                  ...
                                                  <p className="text-sm text-gray-500">Not started solving</p>
                                                )}
                                              </div>
                                            </div>
                                            ...
                                            {ticketDetails.userIssueReason && (
                                              <div className="mt-2 p-3 rounded-md bg-red-50 border border-red-200">
                                                <h3 className="font-semibold">User reason for Resolving the Issue:</h3>
                                                <p className="text-sm mt-1">{ticketDetails.userIssueReasonDetail}</p>
                                                ...
                                                <div className="flex items-center gap-2 mt-2">
                                                  ...
                                                  <div>
                                                    <p className="font-medium">Started Resolving Issue:</p>
                                                    {ticketDetails.resolvingIssue ? (
                                                      <p className="text-sm text-gray-600">
                                                        {new Date(ticketDetails.resolvingIssueTime).toLocaleString(
                                                          "en-US",
                                                          {
                                                            year: "numeric",
                                                            month: "long",
                                                      ...
                                                      <p className="text-sm text-gray-500">Not started resolving</p>
                                                    )}
                                                  </div>
                                                </div>
                                              </div>
                                            ...
                                            <div className="flex items-center gap-2">
                                              ...
                                              <div>
                                                <p className="font-medium">Issue solved or completed:</p>
                                                {ticketDetails.completedIssue ? (
                                                  <p className="text-sm text-gray-600">
