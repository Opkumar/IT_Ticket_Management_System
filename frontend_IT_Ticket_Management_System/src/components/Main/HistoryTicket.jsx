    ...
    try {
      ...
      if (snapshotrequirements.exists()) {
        ...
        snapshotrequirements.forEach((doc) => {
          ...
          if (
            requirementsData.userId === currentUser.uid &&
          ...
          ticketIds.forEach((id) => {
            ...
            const listener = onValue(ticketRef, (snapshot) => {
              ...
              if (ticketInfo) {
                ...
                // Update state with the new or updated ticket
                setTicketTracking((prevData) => {
                  ...
                  if (existingIndex !== -1) {
                    ...
                    updatedData[existingIndex] = formattedTicket;
                    return updatedData;
                  } else {
                    // Add new ticket
                    return [...prevData, formattedTicket];
                  }
                });
              } else {
                console.warn(
                        ...
                        <div className="flex gap-2 items-center">
                          ...
                          <p className="text-gray-600 mb-1">
                            {requirement.assignedDate ? (
                              ...
                              <span className="text-red-400 font-bold">No</span> // Changed to <span>
                            )}
                          </p>
                        </div>
